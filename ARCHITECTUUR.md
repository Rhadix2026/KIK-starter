...
flowchart LR
    ...
    subgraph Afnemer["Afnemer / ketenpartij"]
      UIT["Rhadix Uitvraag<br/>Opvragen + Analyse/Monitor"]
    end
...
- **Rhadix Uitvraag** — vraag & analyse aan de afnemerskant.
...
2. **Publicatieplatform.** Bron van ontologie, uitwisselprofielen en gevalideerde
   SPARQL-queries. Rhadix Uitvraag haalt profielen nu uit een ingebouwde/instelbare
...
3. **Adressering.** Een datastation vinden via een gevalideerd KvK-nummer uit het
   ...
   Rhadix Uitvraag is daar de pragmatische twin-variant van.
